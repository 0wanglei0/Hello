...
<html>
  <head>
    ...
    <title>组织机构</title><LINK href="CSS.css" type=text/css 
rel=stylesheet>
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td bgcolor='#CCFFFF'>编号</td><td bgcolor='#CCFFFF'>组织名称</td><td bgcolor='#CCFFFF'>负责人</td><td bgcolor='#CCFFFF'>电话</td><td bgcolor='#CCFFFF'>传真</td><td bgcolor='#CCFFFF'>备注</td>
  ...
  <%
  String sql="";
  sql="select * from zuzhijigou where 1=1";
  ...
  {
  	sql=sql+" and zuzhimingcheng like '%"+new String(request.getParameter("mingcheng").getBytes("8859_1"))+"%'";
  }
...
%>
  <tr>
    ...
    <td width="60" align="center"><a href="zuzhijigou_updt.jsp?id=<%=id%>">修改</a>  <a href="del.jsp?id=<%=id %>&tablename=zuzhijigou" onClick="return confirm('真的要删除？')">删除</a></td>
  </tr>
  	<%
  }
   %>
