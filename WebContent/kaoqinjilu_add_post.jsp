...
//else{
  	  	...
  	  	String sql="insert into kaoqinjilu(gonghao,xingming,kaoqin,riqi,beizhu) values('"+gonghao+"','"+xingming+"','"+kaoqin+"','"+riqi+"','"+beizhu+"') ";
  	  	
  	  	connDbBean.executeUpdate(sql);
  	  	out.print("<script>alert('添加成功!!');location.href='kaoqinjilu_add.jsp';</script>");
