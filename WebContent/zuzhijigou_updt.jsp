...
<html>
  <head>
    ...
    <title>组织机构</title><script language="javascript" src="js/Calendar.js"></script>
...
function check()
{
  ...
  String id=request.getParameter("id");
   %>
  <form name="form1" id="form1" method="post" action="zuzhijigou_updt_post.jsp?id=<%=id %>">
  修改组织机构:
  <br><br>
  <%
  String sql="select * from zuzhijigou where id="+id;
  ...
  bianhao=RS_result.getString("bianhao");zuzhimingcheng=RS_result.getString("zuzhimingcheng");fuzeren=RS_result.getString("fuzeren");dianhua=RS_result.getString("dianhua");chuanzhen=RS_result.getString("chuanzhen");beizhu=RS_result.getString("beizhu");
   ...
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
     <tr><td>编号：</td><td><input name='bianhao' type='text' id='bianhao' value='<%= bianhao%>' /></td></tr><tr><td>组织名称：</td><td><input name='zuzhimingcheng' type='text' id='zuzhimingcheng' size='50' value='<%=zuzhimingcheng%>' /></td></tr><tr><td>负责人：</td><td><input name='fuzeren' type='text' id='fuzeren' value='<%= fuzeren%>' /></td></tr><tr><td>电话：</td><td><input name='dianhua' type='text' id='dianhua' value='<%= dianhua%>' /></td></tr><tr><td>传真：</td><td><input name='chuanzhen' type='text' id='chuanzhen' value='<%= chuanzhen%>' /></td></tr><tr><td>备注：</td><td><textarea name='beizhu' cols='50' rows='5' id='beizhu'><%=beizhu%></textarea></td></tr>
    <tr>
      <td>&nbsp;</td>
