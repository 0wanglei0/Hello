...
String sql="update yuangongxinxi set gonghao='"+gonghao+"',xingming='"+xingming+"',xingbie='"+xingbie+"',chushengnianyue='"+chushengnianyue+"',dianhua='"+dianhua+"',youxiang='"+youxiang+"',jiguan='"+jiguan+"',zuzhijigou='"+zuzhijigou+"',mima='"+mima+"',zhicheng='"+zhicheng+"',beizhu='"+beizhu+"' where id= "+id;
