...
String sql="update zuzhijigou set bianhao='"+bianhao+"',zuzhimingcheng='"+zuzhimingcheng+"',fuzeren='"+fuzeren+"',dianhua='"+dianhua+"',chuanzhen='"+chuanzhen+"',beizhu='"+beizhu+"' where id= "+id;
connDbBean.executeUpdate(sql);
out.print("<script>alert('ÐÞ¸Ä³É¹¦!!');location.href='zuzhijigou_list.jsp';</script>");
%>
  </body>
</html>
