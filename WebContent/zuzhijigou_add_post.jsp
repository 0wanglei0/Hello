...
ResultSet RS_result=connDbBean.executeQuery("select * from [zuzhijigou] where bianhao='"+bianhao+"'");
...
out.print("<script>alert('该编号已经存在,请换其他编号!');window.history.go(-1);</script>");
  	  	...
  	  	String sql="insert into zuzhijigou(bianhao,zuzhimingcheng,fuzeren,dianhua,chuanzhen,beizhu) values('"+bianhao+"','"+zuzhimingcheng+"','"+fuzeren+"','"+dianhua+"','"+chuanzhen+"','"+beizhu+"') ";
  	  	
  	  	connDbBean.executeUpdate(sql);
  	  	out.print("<script>alert('添加成功!!');location.href='zuzhijigou_add.jsp';</script>");
